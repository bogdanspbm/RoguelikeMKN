...
Мир генерируется из тайлов. Каждый тайл содержи различный тип, проходимый и не проходимый. Примером непроходимого тайла может быть водоем. Текстуры шума перлина, различного разрения будут использоваться для генерации водоемов, биомов (для определения текстуры тайла), расположения объектов и так далее.
