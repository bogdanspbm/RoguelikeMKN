...
>
    ...
    5.1. Персонаж пользователя не атакует бота.
	    ...
	    5.1.2.  Если персонаж попал в радиус атаки противника, то враг атакует его.
		5.1.2.1. Если у персонажа перед атакой более одной единицы здоровья, то после успешной атаки он теряет одну условную единицу здоровья
